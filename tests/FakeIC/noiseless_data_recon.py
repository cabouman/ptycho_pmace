...
'''
This script demonstrates reconstruction of complex transmittance images using PMACE. Demo functionality includes:
...
def build_parser():
    ...
    parser.add_argument('config_dir', type=str, help='Path to config file.', nargs='?', 
                        const='noiseless_data_recon.yaml',
                        default='config/noiseless_data_recon.yaml')
    return parser
...
def main():
    ...
    pmace_dir = save_dir + 'obj_data_fit_prm_{}_probe_exp_{}/'.format(object_prm, probe_exp)
