...
def build_parser():
    ...
    parser.add_argument('config_dir', type=str, help='Configuration file.', nargs='?', const='GoldBalls_blind_joint_recon.yaml',
                        default='config/GoldBalls_blind_joint_recon.yaml')
    return parser
