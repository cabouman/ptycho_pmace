...
parser.add_argument('config_dir', type=str, help='Path to config file.',
                    nargs='?', const='gen_syn_data.yaml', default=os.path.join(root_dir, 'experiment/synthetic_data_experiment/config/gen_syn_data.yaml'))
...
scan_coords = get_proj_coords_from_data(scan_loc, np.ones(num_agts, probe.shape[0], probe.shape[1]))
